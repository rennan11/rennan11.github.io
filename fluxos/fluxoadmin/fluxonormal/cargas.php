...
?>
    <br>
    <div id="alert-pay" class="alert alert-success alert-dismissible fade show noshow" role="alert">
        Motorista Pago com Sucesso.
    ...
    <div class="container card-fixed">
        <div class="card-body">
            <h3 class="card-title title">Histórico de todas as viagens realizadas na plataforma:</h3>
            <div class="col-sm h4">
                <div class="row">
            ...
            <br>
            <a href="index.php"><button class="btn btn-danger">Sair</button></a><br>
        </div>
    </div>
    ...
    <div id="modalcarga" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-footer">
                <b id="texto-pay" class="text-success noshow">MOTORISTA PAGO</b>
                <button type="button" class="btn btn-success" data-dismiss="modal" id="pay-button" onclick="showAlerta()">Pagar Motorista</button><br>
...
<script>
    ...
    function showAlerta() {
        console.log($("#modal-carga-nome").html());
        if($("#modal-carga-nome").html() == "Carga 1") carga1alert = true;
        if($("#modal-carga-nome").html() == "Carga 3") carga3alert = true;
        console.log(carga1alert);
        $("#alert-pay").show();
    }
    ...
    function vercarga(numcarga) {
        switch(numcarga) {
            case 1: {
                ...
                if(carga1alert == false) $("#pay-button").show();
                else {
                    $("#pay-button").hide();
                    $("#texto-pay").show();
                }
            ...
            case 3: {
                ...
                $("#modal-carga-enddestino").html("São Paulo-SP");
                $("#modal-carga-cepdestino").html("04236-094");
                if(carga3alert == false) $("#pay-button").show();
                else {
                    $("#pay-button").hide();
                    $("#texto-pay").show();
                }
