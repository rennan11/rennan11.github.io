...
if(in_array($_SERVER['HTTP_HOST'], array('localhost', "192.168.1.149", "::1"))) {
    define("LOCAL", true);
    define("BASE_URL", (SECURE ? "https" : "http") . "://localhost/rennan11.github.io/fluxos/fluxoadmin/fluxonormal/");
    ...
    define("LOCAL", false);
    define("BASE_URL", (SECURE ? "https" : "http") . "://rennansantos.me/fluxos/fluxoadmin/fluxonormal/");
